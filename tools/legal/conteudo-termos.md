...
**1.4.** Termos adicionais poderão se aplicar a determinados serviços ou assinaturas, tais como ofertas para uma data, atividades ou campanhas promocionais, e suas regras serão oportunamente divulgadas em relação aos respectivos serviços ou assinaturas. No que não forem conflitantes, os termos adicionais são complementares e considerados parte integrante deste Contrato.

**1.5.** Em caso de dúvidas acerca destes Termos, entre em contato conosco através de algum dentre os seguintes canais: WhatsApp da Cora **(21) 97105-9962** e e-mail oi@acora.com.br.

## 2. Definições

**2.1.** No decorrer do presente Contrato, as palavras adiante listadas, quando empregadas, terão as seguintes definições:

- **Assinante:** a pessoa física, maior de 18 anos, que contrata a assinatura e é responsável pelo pagamento. Caso você tenha menos de 18 anos, poderá utilizar nossos serviços através da assinatura de um de seus pais ou responsável.
- **Destinatário:** quem recebe a cesta no endereço de entrega. Normalmente é o próprio Assinante; no entanto, pode ser outra pessoa indicada por ele (cláusula 3.4).
...
**3.1.** Para usufruir do serviço da Cora, o Assinante deverá criar uma conta, informando nome, CPF, e-mail, WhatsApp e o endereço completo de entrega, bem como identificar o método de pagamento. Cabe integralmente ao Assinante a responsabilidade pela exatidão desses dados e por mantê-los atualizados no Portal ou pelo WhatsApp.

**3.2.** A Cora realizará entregas apenas nos domicílios situados nas áreas de cobertura divulgadas no Portal. Cadastros fora dessas áreas entrarão em lista de espera e não gerarão cobrança até que a área seja atendida e você confirme a assinatura.

**3.3.** A assinatura é pessoal e para consumo próprio. Revenda dos produtos não é permitida.

**3.4.** No caso de Assinante e Destinatário distintos, ressaltamos que:

- o Assinante continua sendo a única parte contratante e responsável pelo pagamento;
- a cobrança é emitida em nome do Assinante e toda comunicação financeira vai só para ele;
- o Destinatário recebe apenas a comunicação operacional (entregas, cardápio, avisos de rota);
- o Assinante garante que tem autorização do Destinatário para informar os dados dele à Cora.

**3.5.** **Mais de uma assinatura.** Você pode manter mais de uma assinatura, para o seu endereço e/ou para outros Destinatários. Cada assinatura tem um único endereço de entrega e suas próprias regras de cesta, pausa e cancelamento; a cobrança mensal é uma só, em seu nome, reunindo todas elas, com o detalhamento, no extrato, do valor segregado por assinatura.

**3.6.** **Acesso à conta.** Entenda que você é o único responsável por seu login, senha e toda e qualquer atividade na sua conta. Ao permitir que outras pessoas acessem-na, você concorda que estes estão agindo em seu nome e que você está sujeito às eventuais alterações que eles fizerem, inclusive em caso de utilização indevida. Para ajudar a manter o controle da conta e evitar que usuários não autorizados a acessem, recomendamos ao titular não divulgar a ninguém as credenciais de acesso, e manter atualizados os softwares antivírus e firewall.
...
**4.3.** **Cesta da Semana e Corte.** A cada semana você pode ajustar a Cesta (trocar pão, adicionar Extras) até o Corte divulgado no Portal. Alterações feitas depois do Corte valem para a semana seguinte. O Corte é a única regra de prazo desta relação e existe porque cada fornada é produzida sob medida, sem sobra.
...
**4.6.** **Quinta semana.** Em meses com cinco datas de entrega, a quinta entrega é cortesia da Cora. É uma liberalidade, não uma obrigação contratual, e pode ser encerrada com aviso prévio.

**4.7.** A Cora poderá, a seu exclusivo critério, de modo excepcional, realizar ofertas de assinaturas especiais a seus Assinantes, atuais e/ou pretéritos, com assinatura vigente ou não, as quais poderão ser objeto de adesão por período determinado, sem a necessidade de prévio aviso do início da oferta excepcional e/ou do seu término.

## 5. Preço e reajuste

**5.1.** O preço da Assinatura é composto por um valor mensal por modalidade de assinatura (1, 2 ou 3 pães) mais um valor fixo mensal de entrega (frete), ambos indicados no Anexo I. O preço atualizado de cada modalidade de Assinatura e todos os encargos incorridos por você, tais como os Extras, ajuste proporcional e créditos, bem como as demais condições relativas a cada plano ficarão ampla e continuamente expostos no site e no Portal.

**5.2.** A Cora pode, de tempos em tempos, reajustar os preços da Assinatura e/ou dos Extras, mediante notificação com **pelo menos 30 dias de antecedência**, por e-mail e/ou WhatsApp. O novo preço só passa a valer a partir da renovação mensal, nunca no curso do mês já pago. Se você não concordar com o reajuste, poderá cancelar sua assinatura sem qualquer ônus, antes que ele entre em vigor. Findo o prazo sem que haja manifestação expressa do Assinante solicitando o cancelamento da assinatura, o novo valor será considerado aceito e passará a ser cobrado nas mensalidades seguintes.

## 6. Cobrança e pagamento

**6.1.** **Uma única cobrança por mês.** A Cora emite uma única cobrança recorrente mensal, com o valor já fechado, reunindo:

| Componente | Período | Regra |
|---|---|---|
...
**6.5.** **Primeira cobrança.** É proporcional às entregas restantes do mês em que você assina, sobre mensalidade e frete, e é enviada após a conclusão do cadastro. A assinatura só é ativada, e a primeira entrega só é programada, depois da confirmação do pagamento via cartão de crédito ou da compensação do pagamento via Pix ou boleto bancário.

**6.6.** **Formas de pagamento.** Você pode pagar por **cartão de crédito**, **Pix** ou **boleto**. A cobrança por Pix ou boleto aceita qualquer uma das duas formas, à sua escolha em cada pagamento. O processamento é feito pelo **Asaas Gestão Financeira Instituição de Pagamento S.A.** ("Asaas"), que atua como intermediário de pagamento; a Cora não tem acesso aos dados completos do seu cartão.

**6.7.** **Autorização de cobrança recorrente em cartão de crédito.** Ao escolher cartão de crédito, você autoriza a Cora, por meio do Asaas, a manter os dados do cartão armazenados de forma segura (tokenizados) e a **debitar automaticamente, a cada ciclo mensal, o valor da fatura daquele mês, ciente de que esse valor poderá variar conforme os Extras entregues no ciclo de leitura anterior e eventuais ajustes previstos nestes Termos**. Esta autorização vale até o cancelamento da assinatura ou até que você troque o método de pagamento, o que pode fazer a qualquer momento pelos canais da cláusula 1.5. A Cora se compromete a enviar o extrato da cláusula 6.2 antes de cada débito e a nunca debitar valor diferente do informado nele.

**6.8.** Cartões virtuais que trocam o código de segurança a cada compra podem não aceitar cobrança recorrente: o primeiro pagamento passa e os seguintes são recusados. Se usar cartão virtual, confirme com o seu banco que ele aceita compras programadas.

**6.9.** **Sem multa e sem juros.** A Cora não cobra multa nem juros por atraso. As consequências do não pagamento são apenas as da cláusula 6.10.
...
**6.13.** Ao aderir a estes Termos, o Assinante declara-se ciente de que é o único responsável por todas as cobranças incorridas em relação à sua Assinatura, contemplando a integralidade dos pagamentos, quer relativos à Mensalidade, quer aos Extras.
...
|---|---|
| Pão Original | — |
| Pão Integral | gergelim (na crosta) |
| Ciabatta | — |
| Focaccia Genovesa | — |
| Brioche | ovos, leite e derivados (manteiga) |
| Multigrãos | gergelim, girassol, semente de abóbora, linhaça, quinoa e aveia |
...
Ficou com dúvidas? Venha falar com a gente através dos seguintes canais: WhatsApp da Cora **(21) 97105-9962** e e-mail oi@acora.com.br.
...
| Assinatura | Mensalidade | Frete | Total mensal |
|---|---|---|---|
...
## B. Produtos elegíveis para a Assinatura

Pão Original e Pão Integral, em qualquer combinação, de 1 a 3 pães por semana.
...
- **Formas de pagamento:** cartão de crédito (recorrente), Pix ou boleto.

## G. Régua de atraso (cláusula 6.10 dos Termos)
...
**Destaque da semana.** O produto marcado como destaque no Cardápio é produzido independentemente do mínimo de pedidos.
